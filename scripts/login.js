...
export { entrar, validateUser, generateToken, resetFieldStyles, setErrorStyles, togglePasswordVisibility };
...
// Make functions globally available for browser compatibility
